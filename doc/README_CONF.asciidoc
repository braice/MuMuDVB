...
|hls_storage_dir |Storage directory for HLS files and playlists | /  |  Any HTTP server can point to that dir and produce HLS stream
|hls_rotate_time |HLS chunk duration in seconds| 10 |  First usable playlist will be generated in 2*X seconds after start
|==================================================================================================================
