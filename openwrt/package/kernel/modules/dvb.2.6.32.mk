...
The following modules will be compiled for this device :  dvb-usb-dib0700 dib7000p dibx000_common dib7000m dibx000_common dib8000 dibx000_common dib3000mc dibx000_common s5h1411 lgdt3305 dib0070 mt2060 mt2266 tuner-xc2028 xc5000 mxl5007t
...
define KernelPackage/dvb-usb-dw2102
  SUBMENU:=$(DVB_MENU)
  TITLE:=DvbWorld & TeVii DVB-S/S2 USB2.0 
  ...
  FILES:= $(LINUX_DIR)/drivers/media/dvb/dvb-usb/dvb-usb-dw2102.$(LINUX_KMOD_SUFFIX) \
	...
	$(LINUX_DIR)/drivers/media/dvb/frontends/mt312.$(LINUX_KMOD_SUFFIX) \
	$(LINUX_DIR)/drivers/media/dvb/frontends/zl10039.$(LINUX_KMOD_SUFFIX)
endef

define KernelPackage/dvb-usb-dw2102/description
 Say Y here to support the DvbWorld & TeVii DVB-S/S2 USB2.0 .
The following modules will be compiled for this device :  dvb-usb-dw2102 dvb-pll stv0299 stv0288 stb6000 cx24116 si21xx tda10021 mt312 zl10039
You have to put the firmware files in the download dir : dvb-usb-dw2102.fw dvb-usb-dw2104.fw dvb-usb-dw3101.fw dvb-usb-s630.fw
They can be found in the package http://packages.ubuntu.com/jaunty/linux-firmware .
endef
...
DVB_USB_DW2102_FW_3:=dvb-usb-s630.fw
...
define KernelPackage/dvb-usb-dw2102/install
	...
	$(INSTALL_DATA) $(DL_DIR)/$(DVB_USB_DW2102_FW_3) $(1)/lib/firmware/
endef
...
define KernelPackage/dvb-usb-friio
  SUBMENU:=$(DVB_MENU)
  TITLE:=Friio ISDB-T USB2.0 Receiver 
  KCONFIG:= CONFIG_DVB_USB_FRIIO
  DEPENDS:=+kmod-dvb-usb
  FILES:= $(LINUX_DIR)/drivers/media/dvb/dvb-usb/dvb-usb-friio.$(LINUX_KMOD_SUFFIX)
endef

define KernelPackage/dvb-usb-friio/description
 Say Y here to support the Friio ISDB-T USB2.0 Receiver .
The following modules will be compiled for this device :  dvb-usb-friio

endef



$(eval $(call KernelPackage,dvb-usb-friio))
